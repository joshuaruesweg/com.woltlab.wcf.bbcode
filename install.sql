...
-- media providers
-- Youtube
INSERT INTO wcf1_bbcode_media_provider (title, regex, html) VALUES ('YouTube', 'https?://(?:.+?\\.)?youtu(?:\\.be/|be\\.com/watch\\?(?:.*?&)?v=)(?<ID>[a-zA-Z0-9_-]+)', '<iframe width="420" height="315" src="http://www.youtube.com/embed/{$ID}" frameborder="0" allowfullscreen></iframe>');
-- Vimeo
...
-- Google Video
INSERT INTO wcf1_bbcode_media_provider (title, regex, html) VALUES ('Google Video', 'http://video\\.google\\.(?<TLD>[a-z]{2,3})/videoplay\\?docid=(?<ID>-?\\d+)', '<embed id="VideoPlayback" src="http://video.google.{$TLD}/googleplayer.swf?docid={$ID}&amp;fs=true" style="width:400px;height:326px" allowFullScreen="true" allowScriptAccess="always" type="application/x-shockwave-flash"> </embed>');
-- DailyMotion
