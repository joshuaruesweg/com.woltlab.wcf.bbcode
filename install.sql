...
-- DailyMotion
INSERT INTO wcf1_bbcode_video_provider (title, regex, html) VALUES ('DailyMotion', 'https?://(www\\.)?dailymotion\\.com/video/(?<ID>[a-zA-Z0-9]+)', '<iframe frameborder="0" width="480" height="208" src="http://www.dailymotion.com/embed/video/{$ID}"></iframe>');