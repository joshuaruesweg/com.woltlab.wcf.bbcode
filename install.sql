...
-- Veoh
INSERT INTO wcf1_bbcode_video_provider (regex, html) VALUES ('~http://www.veoh.com/watch/v(?<ID>\\d+[a-zA-Z0-9]+)~', '<object width="410" height="341" id="veohFlashPlayer" name="veohFlashPlayer"><param name="movie" value="http://www.veoh.com/swf/webplayer/WebPlayer.swf?version=AFrontend.5.7.0.1308&permalinkId=v{$ID}&player=videodetailsembedded&videoAutoPlay=0&id=anonymous"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed src="http://www.veoh.com/swf/webplayer/WebPlayer.swf?version=AFrontend.5.7.0.1308&permalinkId=v{$ID}&player=videodetailsembedded&videoAutoPlay=0&id=anonymous" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="410" height="341" id="veohFlashPlayerEmbed" name="veohFlashPlayerEmbed"></embed></object>');
-- Google Video
INSERT INTO wcf1_bbcode_video_provider (regex, html) VALUES ('~http://video.google.(?<TLD>[a-z]{2,3})/videoplay\\?docid=(?<ID>-?\\d+)~', '<embed id="VideoPlayback" src="http://video.google.{$TLD}/googleplayer.swf?docid={$ID}&hl=de&fs=true" style="width:400px;height:326px" allowFullScreen="true" allowScriptAccess="always" type="application/x-shockwave-flash"> </embed>');